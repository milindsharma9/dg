...
<div class="row">
    <div class="col-sm-10 col-sm-offset-2">
        <h1>{{ trans('admin/customercategories.edit') }}</h1>
...
{!! Form::open(array('files' => true,'method' => 'PATCH',  'route' => array('admin.customercategories.update',$clients->id), 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      {!! Form::submit(trans('admin/customercategories.update'), array('class' => 'btn btn-primary')) !!}
