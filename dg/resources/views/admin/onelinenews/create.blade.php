...
<div class="row">
    <div class="col-sm-10 col-sm-offset-2">
        <h1>{{ trans('admin/onelinenews.add_blog') }}</h1>
...
{!! Form::open(array('files' => true, 'route' => 'admin.onelinenews.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      {!! Form::submit(trans('admin/onelinenews.add'), array('class' => 'btn btn-primary')) !!}
