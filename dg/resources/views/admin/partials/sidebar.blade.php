<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            <li @if(isset(explode('/',Request::path())[1]) && explode('/',Request::path())[1] == strtolower('news')) class="active" @endif>
                 <a href="{{ route('admin.news.index') }}">
                    <i class="fa fa-sign-out fa-fw"></i>
                    <span class="title">{{ trans('News') }}</span>
                </a>
            </li>
            <li @if(isset(explode('/',Request::path())[1]) && explode('/',Request::path())[1] == strtolower('onelinenews')) class="active" @endif>
                 <a href="{{ route('admin.onelinenews.index') }}">
                    <i class="fa fa-sign-out fa-fw"></i>
                    <span class="title">{{ trans('Marquee News') }}</span>
                </a>
            </li>
            ...
            <li @if(isset(explode('/',Request::path())[1]) && explode('/',Request::path())[1] == strtolower('customercategories')) class="active" @endif>
                <a href="{{ route('admin.customercategories.index') }}">
                    <i class="fa fa-sign-out fa-fw"></i>
                    <span class="title">{{ trans('Customer Categories') }}</span>
                </a>
            </li>
			<li @if(isset(explode('/',Request::path())[1]) && explode('/',Request::path())[1] == strtolower('homebanner')) class="active" @endif>
                 <a href="{{ route('admin.homebanner.edit',1) }}">
                    <i class="fa fa-sign-out fa-fw"></i>
                    <span class="title">{{ trans('Home Page Banner') }}</span>
                </a>
            </li>
			@endif
			      @if ( Auth::user()->fk_users_role == 5 || Auth::user()->fk_users_role == 1)  
