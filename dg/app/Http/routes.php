...
Route::group([ 'middleware' => []], function () {
	 Route::get('registeruser', 'Admin\UsersController@getContact');
  Route::post('contactfom'
  , [ 'as' => 'contactfom', 'uses' => 'Admin\UsersController@postContact']);
    /*
	Route::get('/', [
        "as"    => 'customer.landing',
...
Route::group([ 'middleware' => ['auth_admin', 'revalidate'], 'prefix' => 'admin'], function () {
	...
	//onelinenews Management
    Route::resource('onelinenews', 'Admin\OnelinenewsController');
    //clients CMS Management
    Route::resource('clients', 'Admin\ClientcmsController');
    
    Route::get('/dashboard',[ 
        'as' => 'admin.dashboard', 
        'uses' => 'Admin\UsersController@getAdminDasboard'
    ]);
    
    //customer Category Management topl level categories
    Route::resource('customercategories', 'Admin\CustomercategoryController');
